      ...
      <section className="relative pt-40 pb-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <span className="text-[#14B8A6] text-xs font-bold tracking-[0.3em] uppercase">
              The Set Claims Standard
            </span>
          </motion.div>
          <h1 className="text-5xl md:text-7xl font-black uppercase tracking-tighter mb-8 leading-[0.95]">
            Comprehensive <br />
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#14B8A6] to-[#38B0E3]">
              RCM Solutions.
            </span>
          </h1>
          <p className="text-gray-400 text-lg md:text-xl max-w-3xl mx-auto font-light leading-relaxed">
            We offer integrated and customizable medical billing services
            designed to maximize your practice revenue while reducing
              ...
              <div className="p-6 md:p-12 overflow-y-auto custom-scrollbar">
                <div className="grid lg:grid-cols-2 gap-12">
                  <div className="space-y-8">
                    ...
                    <div>
                      <h4 className="text-[10px] font-black uppercase tracking-[0.3em] text-[#38B0E3] mb-4">
                        Our Approach
                      </h4>
                  ...
                  <div className="space-y-10">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-[#1D2B80] mb-6 px-2">
                        Services Included
                      </h4>
                      <div className="flex flex-wrap gap-2">
                        {selectedService.details.included.map((item, i) => (
                          <span
                            key={i}
                            className="px-4 py-2 rounded-full bg-gray-100 text-[11px] font-bold uppercase tracking-wider text-gray-500 border border-gray-200"
                          >
                            {item}
                          </span>
                        ))}
