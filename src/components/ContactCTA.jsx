...
const ContactCTA = () => {
  ...
  return (
    <section id='contact-form' className="py-12 md:py-24 bg-white text-[#1D2B80] font-['Poppins'] relative overflow-hidden">
      ...
      {/* Background flyer-inspired gradients */}
      ...
      <div className="max-w-7xl mx-auto px-5 md:px-8 relative z-10">
        {/* Changed lg:grid-cols-2 to grid-cols-1 with lg:grid-cols-2 for desktop */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-start">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="p-6 md:p-12 rounded-[32px] md:rounded-[40px] bg-white shadow-[0_20px_60px_rgba(29,43,128,0.06)] border border-gray-50 w-full"
          >
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="email" placeholder="john@practice.com" required className={inputClass} />
                </div>
                <div>
                  <label className={labelClass}>Phone Number *</label>
                  <input type="tel" placeholder="(555) 000-0000" required className={inputClass} />
                </div>
              </div>
              ...
              <div>
                ...
                <select required className={inputClass}>
                  ...
                  <option value="Other">Other RCM Services</option>
                </select>
              </div>
              ...
              <button 
                ...
                className="w-full bg-[#1D2B80] hover:bg-[#14B8A6] text-white py-4 md:py-5 rounded-2xl font-bold text-base md:text-lg flex items-center justify-center gap-3 transition-all duration-300 shadow-xl shadow-[#1D2B80]/20 active:scale-95 disabled:opacity-70"
              >
                {isSubmitting ? "Sending Request..." : "Request Free Demo"}
